"""
Functions to generate a Markov Decision Process view of the environment.
"""
import numpy as np
...
def build_mdp(labyrinth):
    ...
    initial_state = state_to_key(labyrinth.state)
    ...
    while to_explore:
        ...
        labyrinth.state = key_to_state(state_key, labyrinth.state.shape)

        # Simulate step
        next_state, reward, _, _, _ = labyrinth.step(action)
